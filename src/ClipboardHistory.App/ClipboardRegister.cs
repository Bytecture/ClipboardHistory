...
namespace ClipboardHistory.App
{
    ...
    public delegate void ThresholdReachedEventHandler(object sender, ClipboardCopyEventArgs e);
    public class ClipboardRegister: IDisposable
    {
        public IntPtr ClipboardViewerNext { get; set; }
        IntPtr _handle;
        Queue<string> _hyperlink = new Queue<string>();

        public event ThresholdReachedEventHandler OnClipboardCopy;
        ...
        public ClipboardRegister(IntPtr handle)
        {
            _handle = handle;
        ...
        {
            ClipboardViewerNext = RAD.ClipMon.Win32.User32.SetClipboardViewer(_handle);
        }
        ...
        {
            RAD.ClipMon.Win32.User32.ChangeClipboardChain(_handle, ClipboardViewerNext);
        }
        ...
        public void GetClipboardData()
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    //
                    //_clipboardText = "(cannot display this format)";
                }
            }
